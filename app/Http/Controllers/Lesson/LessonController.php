...
class LessonController extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/sections/{section_id}/lessons/{lesson_id}/finished",
     *     summary="Retorna todos os alunos que terminaram essa aula",
     *     operationId="GetLessonsFinished",
     *     tags={"users","lessons"},
     *     @OA\Parameter(
     *         name="section_id",
     *         in="path",
    ...
    public function getFinishedLessons(Request $request, int $section_id, int $lesson_id)
    {
        $data = Section::findOrFail($section_id)
            ->lessons()->findOrFail($lesson_id);
        return $this->success($data->finished()->paginate(15));
    }

    /**
     * @OA\Post(
     *     path="/sections/{section_id}/lessons/{lesson_id}/finished",
     *     summary="Insere um novo usuário que terminou essa aula",
     *     operationId="PostLessonsFinished",
     *     tags={"users","lessons"},
     *     security={{"apiToken":{}}},
     *     @OA\Parameter(
     *         name="section_id",
    ...
    public function postFinishedLessons(Request $request, int $section_id, int $lesson_id)
    {
        $data = Section::findOrFail($section_id)
            ->lessons()->findOrFail($lesson_id);
        $data = $data->finished()->attach(Auth::user()->id);
